...
inline void ReadMLP::Initialize()
{
   ...
   fWeightMatrix0to1[0][0] = -0.170378652839955;
   fWeightMatrix0to1[1][0] = 1.3550284563385;
   fWeightMatrix0to1[2][0] = 1.21563094176906;
   fWeightMatrix0to1[3][0] = 2.89684035070019;
   fWeightMatrix0to1[4][0] = -1.61660814140212;
   fWeightMatrix0to1[5][0] = -1.90821356308556;
   fWeightMatrix0to1[6][0] = -0.16317655169307;
   fWeightMatrix0to1[7][0] = 2.12720372427795;
   fWeightMatrix0to1[0][1] = -1.49910879025085;
   fWeightMatrix0to1[1][1] = -0.817070378611099;
   fWeightMatrix0to1[2][1] = -1.21462849908385;
   fWeightMatrix0to1[3][1] = 1.76554045397385;
   fWeightMatrix0to1[4][1] = -1.36745802809262;
   fWeightMatrix0to1[5][1] = -0.963831189478062;
   fWeightMatrix0to1[6][1] = -0.324173518441141;
   fWeightMatrix0to1[7][1] = 1.14913660067963;
   fWeightMatrix0to1[0][2] = -1.14292640997911;
   fWeightMatrix0to1[1][2] = 2.2932835932033;
   fWeightMatrix0to1[2][2] = 0.287844646713419;
   fWeightMatrix0to1[3][2] = 2.10603669584047;
   fWeightMatrix0to1[4][2] = -2.04094888119843;
   fWeightMatrix0to1[5][2] = 2.04500582350081;
   fWeightMatrix0to1[6][2] = 0.587831405708048;
   fWeightMatrix0to1[7][2] = 1.63251101229645;
   fWeightMatrix0to1[0][3] = -0.371043387345152;
   fWeightMatrix0to1[1][3] = -0.405846219127921;
   fWeightMatrix0to1[2][3] = 1.80666187903662;
   fWeightMatrix0to1[3][3] = -3.09955001840191;
   fWeightMatrix0to1[4][3] = -1.84728781343277;
   fWeightMatrix0to1[5][3] = 0.276603584767676;
   fWeightMatrix0to1[6][3] = 2.36057111622865;
   fWeightMatrix0to1[7][3] = 1.60701105671182;
   // weight matrix from layer 1 to 2
   fWeightMatrix1to2[0][0] = -0.548351474112045;
   fWeightMatrix1to2[0][1] = 0.325648105456223;
   fWeightMatrix1to2[0][2] = -1.78497149701659;
   fWeightMatrix1to2[0][3] = -2.42678341167183;
   fWeightMatrix1to2[0][4] = -2.37120345621023;
   fWeightMatrix1to2[0][5] = 1.2843303778776;
   fWeightMatrix1to2[0][6] = -3.01870988251931;
   fWeightMatrix1to2[0][7] = 1.69523536578475;
   fWeightMatrix1to2[0][8] = -1.17143073165271;
}
